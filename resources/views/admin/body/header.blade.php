	...
	<div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
		...
		<div class="d-flex d-lg-none align-items-center ms-n2 me-2">
			...
			<a href="#" class="d-flex align-items-center">
				<img alt="Logo" src="{{asset('backend/media/logos/logo-demo7.svg')}}" class="h-30px" />
			</a>
			<!--end::Logo-->
		</div>
		...
		<div class="d-flex flex-shrink-0" id="kt_header_search" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="enter" data-kt-search-layout="menu" data-kt-menu-trigger="auto" data-kt-menu-permanent="true" data-kt-menu-placement="bottom-start">
			<!--begin::Form-->
